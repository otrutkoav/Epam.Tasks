...
namespace Triangle
{
    public class Triangle
    {
        ...
        public double GetMaxSide(out double firstSmallSide, out double secondSmallSide)
        {
            if ((this.SideC > this.SideA) && (this.SideC > this.sideB))
            {
                firstSmallSide = this.SideA;
                secondSmallSide = this.SideB;
                return SideC;
            }
            else if ((this.SideA > this.SideC) && (this.SideA > this.sideB))
            {
                firstSmallSide = this.SideC;
                secondSmallSide = this.SideB;
                return this.SideA;
            }
            else
